...
import { Plus, Sparkles, Shuffle, Flower2, Flame, CloudRain } from 'lucide-react';
      ...
      >
        ...
        <motion.div variants={slideUp} className="w-full flex flex-col items-center">
          ...
          <div className="flex flex-row justify-center gap-4 w-full">
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center bg-rose-50 border-2 border-rose-200 rounded-full shadow-sm hover:bg-rose-100 transition-colors">
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center bg-blue-50 border-2 border-blue-200 rounded-full shadow-sm hover:bg-blue-100 transition-colors">
                <Flower2 className="w-6 h-6 text-blue-400" strokeWidth={1.5} />
              </div>
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center bg-orange-50 border-2 border-orange-200 rounded-full shadow-sm hover:bg-orange-100 transition-colors">
            ...
            >
              <div className="w-14 h-14 flex items-center justify-center bg-pink-50 border-2 border-pink-200 rounded-full shadow-sm hover:bg-pink-100 transition-colors">
                <CloudRain className="w-6 h-6 text-pink-500" strokeWidth={1.5} />
              </div>
